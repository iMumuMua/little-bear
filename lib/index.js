...
LittleBear.prototype._init = function() {
    if (typeof this._opts.beforeInitRoutes === 'function') {
        this._opts.beforeInitRoutes(this.app);
    }
    ...
    if (typeof this._opts.afterInitRoutes === 'function') {
        this._opts.afterInitRoutes(this.app);
    }
